...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        ...
        message.put(Constants.KEY_SENDER_ID, preference.getString(Constants.USER_ID));
        ...
        if (conversionID != null) {
            ...
            conversion.put(Constants.KEY_SENDER_ID, preference.getString(Constants.USER_ID));
            conversion.put(Constants.KEY_SENDER_NAME, preference.getString(Constants.KEY_NAME));
            conversion.put(Constants.KEY_SENDER_IMAGE, preference.getString(Constants.KEY_IMAGE));
